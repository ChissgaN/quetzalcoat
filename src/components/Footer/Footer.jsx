...
const Footer = () => {
  return (
    <footer className=' bg-[#092469] w-full flex justify-between px-4'>
      <div className='py-4'>
        <a href='mailto:unikolorxela@gmail.com' className='flex gap-3' target='_blank' rel='noopener noreferrer'>
          <img src={mail} alt="mail" />
          <p className='text-white'>Mayoristas</p>
        </a>
        <a href='https://wa.me/50236885254' className='flex gap-3' target='_blank' rel='noopener noreferrer'>
